...
export const DICT = {
  en: {
    ...
    'd0.s2d': 'Boil in plenty of salted water until it is roughly seventy percent done. It finishes later in the steam, so taking it off early is the point.',
    'd0.s3t': 'Mix it with the chicken curry',
    'd0.s3d': 'The chicken curry goes in the bottom of the pot and the boiled rice goes over it, then the saffron colour, the fried onion and the mint. It is layered, not stirred.',
    'd0.s4t': 'Dum',
  ...
  ur: {
    ...
    'd0.s2t': 'چاول ابالیں',
    'd0.s2d': 'کھلے نمکین پانی میں تقریباً ستر فیصد تک ابالیں۔ باقی پکائی بعد میں بھاپ سے ہوتی ہے، اسی لیے جلدی اتارنا ہی اصل بات ہے۔',
    'd0.s3t': 'چکن کے سالن میں ملائیں',
    'd0.s3d': 'چکن کا سالن دیگ کی تہہ میں اور اوپر ابلا ہوا چاول، پھر زعفرانی رنگ، تلی ہوئی پیاز اور پودینہ۔ یہ تہہ در تہہ لگتا ہے، ہلایا نہیں جاتا۔',
    'd0.s4t': 'دم',
